...
/**
 * Représentation mémoire de tous les agents Aucun stockage persistant. Cette
...
public class Agents {
	...
	/**
	 * Ajoute une intervention dans le dépos. Note : Ecrase l'ancien agent si la
	...
	/**
	 * Retourne l'instance d'Agent associé au uniqueID s'il est présent, null si
	 * non trouvé.
	 * 
	 * @param uniqueID
